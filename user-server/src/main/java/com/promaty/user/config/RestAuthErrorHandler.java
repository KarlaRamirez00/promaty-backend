...
/**
 * Los rechazos de la cadena de seguridad ocurren antes del GlobalExceptionHandler, asi que este
 * handler emite el mismo shape de error del resto de la API (401 sin/mal token, 403 sin permiso).
 */
